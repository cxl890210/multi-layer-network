...
public class MultiCommAttackModel {
//	随机攻击过程(1-p)比例的随机攻击
	public void attackProcess(TripleCommNet netWork1,TripleCommNet netWork2,TripleCommNet netWork3,double attackProb)
	{
//		初始攻击A网络的社区1
		int communitySize = netWork1.community.get(0).communitySize;
	...
	//级联失效过程
	public void cascadeProcess(HashSet<Integer> failedSet,TripleCommNet netWork1,TripleCommNet netWork2
			,TripleCommNet netWork3)
	{
...
//	分阶段级联
	public HashSet<Integer> partialCascade(HashSet<Integer> failedSet,TripleCommNet attNetWork
			,TripleCommNet casNetWork,TripleCommNet otherNetwork)
	{
		HashSet<Integer> set1,set2;
		set1=set2=failedSet;
...
// 		寻找第三个网络中，因前两个网络级联而失效的节点集合
	...
	public HashSet<Integer> failedFunc(HashSet<Integer> failedSet,TripleCommNet attNetwork,TripleCommNet casNetWork)
	{
...
//		寻找set2
	...
	public int getGiantComponent(TripleCommNet netWork,ArrayList<Integer> attackedCluster)
	{
...
//对原网络中每个被攻击的分支进行广度优先搜索
	public void BFS(int clusterNum,TripleCommNet netWork)
	{
